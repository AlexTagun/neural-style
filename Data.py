...
class UserData:
    def __init__(self, image_path, style_path, width, iterations, max_side):
...
def save_user_data(image_path, style_path, width, iterations, max_side):
...
def get_user_data():
    ...
    if not os.path.exists(path):
        ...
        iterations = "10"
        max_side = "400"
        save_user_data(image_path, style_path, width, iterations, max_side)
    new_file_lines = []
